window.addEventListener('DOMContentLoaded', function() {
	...
	class MenuCard {
		constructor(src, alt, title, descr, price, parentSelectror, ...classes) {
			this.src = src;
			this.alt = alt;
			this.title = title;
			this.descr = descr;
			this.parent  = document.querySelector(parentSelectror);
			this.price = price;
	...
	function postData (form) {
		form.addEventListener('submit', (e) => {
			...
			requset.setRequestHeader('Content-type', 'multipart/form-data');
